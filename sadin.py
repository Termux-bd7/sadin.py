...
def language(cookie):
	...
	try:
		...
		url = ses.get('https://m.facebook.com/language/',cookies=cookie)
...
def cek_apk(idf,pw,kuki):
	...
	try:			
		...
		url = "https://m.facebook.com/settings/apps/tabbed/?tab=inactive"
	...
	try:			
		...
		url = "https://m.facebook.com/settings/apps/tabbed/?tab=removed"
